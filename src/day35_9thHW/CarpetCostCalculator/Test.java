...
public class Test {
	/*
	# Task - Carpet Cost Calculator

	The Carpet Company has asked you to write an application that calculates the price of carpeting for
	rectangular rooms. To calculate the price, you multiply the area of the floor (width times length)
	by the price per square meter of carpet. 

	For example, the area of the floor that is 12 meters long
	and 10 meters wide is 120 square meters. To cover the floor with a carpet that costs $8 per square
	...
	* Method named **getArea without any parameters**, it needs to **return** the calculated area
	...
	The class needs to have one constructor with parameter **cost** of type **double** and it needs to
	...
	* Method named **getCost without any parameters**, it needs to **return** the value of **cost**
	  field
