...
/*
	...
	1. `startEngine` accepts no parameters and returns a message which says that the car's engine is 
	   starting
	...
	Two getter methods should also be defined here for the member variables `cylinders` and `name`. All 
	...
	The return messages for these methods should somewhere **contain the name** of th class to which the 
	methods belong.
	...
	###Notes:
	- Remember that you Main class is not included in the code evaluation.
	- You should paste the code from each of your classes into respective class file in the code 
	  evaluator.
	  */
